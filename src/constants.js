...
export const MODULOS_SISTEMA = [
    ...
    { id: 'lead_time_operacional', label: 'Lead Time Operacional' }
];
...
export const STATUS_CUBAGEM = [
    'EM SEPARAÇÃO','SEPARADO','CARREGANDO','PEDIDO EM PLANEJAMENTO',
    'AGUARD.SEPARAÇÃO','PENDENTE','CANCELADO','COLETADO',
    'BLOQUEADO PELO COMERCIAL','DEVOLUÇÃO REALIZADA','PENDENTE ANTECIPADO',
    'SEPARADO / EM ETIQUETAGEM','SEPARADO / AVALIAÇÃO DAS PEÇAS',
    'SEPARADO / EM PROCESSO DE EMBALAGEM','SEPARADO / EM PROCESSO DE PALETIZAÇÃO',
    'SEPARADO / EM PROCESSO DE RETRABALHO','SEPARADO / AGUARDANDO ETIQUETA',
];
...
export const TRAMONTINA_OPERACAO_CODIGOS = [
    ...
    { codigo: 'P',  label: 'Porcelana' },
    { codigo: 'DC', label: 'Delta + Consolidado' },
    { codigo: 'PC', label: 'Porcelana + Consolidado' },
];
