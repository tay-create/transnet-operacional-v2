...
module.exports = function createVeiculosRouter(io, registrarLog, getResultadoSheetIdFn) {
    ...
    //
    // IMPORTANTE: precisa vir ANTES de /veiculos/:id, senão o Express tenta interpretar
    // "operacao-por-coleta" como :id integer e o psql retorna 500.
            ...
            // ── Timestamps ISO completos para SLA (autoritativo) ──────────────────
            {
                ...
                if (v.status_recife !== srAntigo) {
                    ...
                    if (v.status_recife === 'CARREGADO') {
                        ...
                        // Transição para CARREGADO (srAntigo !== 'CARREGADO' garantido pelo if externo):
                        // sempre atualiza a data para refletir o dia real do carregamento atual.
                ...
                if (v.status_moreno !== smAntigo) {
                    ...
                    if (v.status_moreno === 'CARREGADO') {
                        ...
                        // Transição para CARREGADO (smAntigo !== 'CARREGADO' garantido pelo if externo):
                        // sempre atualiza a data para refletir o dia real do carregamento atual.
