...
export default function ChecklistLogin() {
        ...
        try {
            ...
            if (data.success && userData) {
                if (userData.cargo !== 'Coordenador') {
                    setErro('Acesso restrito ao Coordenador.');
                    logout();
                    setLoading(false);
                    return;
                }
        ...
        <div className="login-wrapper">
            <div className="login-card-compact">
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '10px' }}>
                    ...
                    <span className="brand-subtitle" style={{ color: '#3b82f6' }}>PORTAL DO COORDENADOR</span>
                </div>
