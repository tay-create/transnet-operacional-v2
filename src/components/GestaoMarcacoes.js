                                            ...
                                            <tr key={m.id}>
                                                ...
                                                <td style={{ ...s.td, maxWidth: '180px' }}>
                                                    ...
                                                    <div style={{ display: 'flex', gap: '3px', flexWrap: 'wrap', marginTop: '2px' }}>
                                                        ...
                                                        {!m.is_frota && (m.viagens_realizadas ?? 0) === 0 && m.ja_carregou !== 'Sim' ? <span style={{ fontSize: '9px', fontWeight: '700', color: '#fb923c', background: 'rgba(251,146,60,0.12)', border: '1px solid rgba(251,146,60,0.3)', borderRadius: '3px', padding: '0 4px' }}>NOVATO</span> : null}
                                                    </div>
                                                    {linkWpp(m.telefone) ? (
