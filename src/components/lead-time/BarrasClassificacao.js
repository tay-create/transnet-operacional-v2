...
// Recebe { titulo, totais: { antecipado, dentro, fora, aguardando, total, mediaDias } }
// Renderiza barras horizontais com 3 (ou 4 se houver aguardando) categorias.
export default function BarrasClassificacao({ titulo, totais, height = 220 }) {
