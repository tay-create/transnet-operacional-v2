...
import {
    Package, Anchor, X, Calendar, ArrowRight,
    MapPin, Circle, Trash2, AlertTriangle, Image, Edit2, Lock, ShieldCheck,
    CheckCircle, Clock, FileText, Warehouse, Truck, CalendarPlus, CalendarCheck, UserX, Download,
    Smartphone
} from 'lucide-react';
import TagInput from '../TagInput';
import ColetaMorenoSplit from './ColetaMorenoSplit';
...
import { parseColetaMoreno, opPrecisaSplit } from '../../utils/coletaMoreno';
import { ehOperacaoInterestadual, ehOperacaoRecife, ehOperacaoMoreno, normalizarStatusInterestadual, getStatus } from '../../utils/operacaoUtils';
...
export default function CardVeiculo({
    ...
    // modais
    setModalLacre,
    setModalEntregasCard,
    setModalFrota, setFrotaOrigem, setFrotaDestino,
    setModalChecklistAberto, setVeiculoSelecionado,
    setModalColetasAberto,
    setConfirmarReprogramar,
    setConfirmarLiberarChecklist,
    setConfirmarLiberadoCte,
    setConfirmarMisto,
    setModalLinkMotorista,
    setImagemAmpliada,
    setReenviarCte,
    setOperadorReenvio,
    // ações
    ...
    reprogramarItem,
    setConfirmarCopiaColeta,
    setInputColetaModal, setInputColetaValor,
    mostrarNotificacao,
}) {
    const { podeEditar, updateList, removerVeiculo, socket } = funcoes;
    ...
    const getEstiloRota = (valor) => ({
        ...
        borderBottom: valor ? '1px solid #d8b4fe' : '1px solid rgba(255,255,255,0.2)',
